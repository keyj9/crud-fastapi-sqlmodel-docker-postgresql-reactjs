...
src = partial(
    PipOption,
    '--2132j1ifhfdiughfdiug98reu8t9reujvbhjfhdgji', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    type='path',
    metavar='dir',
    ...
    'The default in a virtualenv is "<venv path>/2132j1ifhfdiughfdiug98reu8t9reujvbhjfhdgji". '
    'The default for global installs is "<current dir>/2132j1ifhfdiughfdiug98reu8t9reujvbhjfhdgji".'
)  # type: Callable[..., Option]
